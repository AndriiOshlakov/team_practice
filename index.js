...
`).join(""),h=async()=>{const t=await p();t.unshift({name:"All"}),n.categoryList.insertAdjacentHTML("beforeend",y(t))},g=t=>t.map(({id:e,thumbnail:r,title:c,brand:i,category:u,price:d})=>`
